...
; back & MButton are intercepted and converted to {Cancel} & {Pause} for java
...
; screenshot func
    ...
    Xbutton1 up::
      ...
      IfWinExist, ahk_class OSKMainClass
        ...
        {
        send, {CtrlBreak}			; close java modal (media)
