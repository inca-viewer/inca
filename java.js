...
// sleep2 formatting error in globals  localStorage.setItem('pageView'+folder, x); setWidths(index,36)

// rem errors in htm console
  ...
  function addMedia() {
    ...
    if (currentLine != lastLine) {
      ...
      else if (currentLine.includes('file:///')) {
