  ...
  function clickEvent() {								// functional logic
    ...
    else if (!longClick && lastClick && lastClick!=2 && (thumbSheet || id=='myPic')) {getStart(); return}
    ...
    else if (longClick==1 && (overMedia || id=='myPic')) thumb.currentTime=0.01		// cannot be zero - see getPara.
