            ...
            Loop, Parse, str2, `n, `r
              if %A_LoopField%  
                if InStr(A_LoopField, "-->")				; timestamp - warning!! care making changes to this element
                  text = %text%<b onclick='thumb.play(); thumb.muted=0' onmouseenter="overThumb(%j%); thumb.currentTime=vttTime('%A_LoopField%')">%A_LoopField%</b>
