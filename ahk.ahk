...
<video id='myPic' onwheel='wheelEvent(event)' class='pic' muted></video>`n
...
<div id='myNav' class='context' onmouseout='zoom = 1' onwheel='wheelEvent(event)'>`n
